...
First download the package from https://github.com/DataScienceScotland writing the code below in the console. (quitándole los hastags, lo escribes en la consola por que sólo se hace una vez para la instalación). 
```{r}
...
Retrieving one of the 288 datasets using its URI. (creas un nuevo objeto y ya la tienes en tu enviroment para trabajar con ella como quieras) 
```{r}
